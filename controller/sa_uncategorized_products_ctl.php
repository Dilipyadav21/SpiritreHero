...
$s3Obj = new Aws3;
class sa_uncategorized_products_ctl extends sa_products_mdl
{
	public $TempSession = "";
	...
	function productsPagination(){
		if(parent::isPOST()){
			if(parent::getVal("hdn_method") == "uncategorized_products_pagination")
			{
				$record_count=0;
				$page=0;
				$current_page=1;
				...
				$cond_tab_status = 'AND is_deleted = "0" AND ( group_id ="0" OR (is_flash_sale="0" AND on_demand="0") ) ';
