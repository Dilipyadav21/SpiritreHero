	...
	function saveTemplate(){
		if(parent::isPOST()){
			if(!empty(parent::getVal("method")) && parent::getVal("method") == "saveEmailBody"){
				...
				$recipients             = (!empty(parent::getVal("recipients")) && parent::getVal("recipients"))?parent::getVal("recipients"):'';
				parent::saveTemplate_f_mdl($email_template_id,$email_template_body,$email_template_subject,$recipients);	
			}
		}
	}
}